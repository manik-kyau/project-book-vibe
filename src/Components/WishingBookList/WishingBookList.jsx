...
const WishingBookList = ({book}) => {
    const {id,bookName,author,image,rating,tags,category,yearOfPublishing,publisher,totalPages} = book;
    return (
        <div>
...
WishingBookList.propeTypes ={
    wishingbookList:PropTypes.array.isRequired,
    book:PropTypes.object.isRequired,
}
export default WishingBookList;