              ...
              <div className="flex gap-12">
                ...
                <div className="w-1/2">
                  ...
                  <div className="space-x-4 ">
                    <button onClick={()=>handleReadBtn(book)} className="btn bg-white hover:text-white hover:bg-[#23BE0A] border-2 text-lg font-semibold border-gray-300 hover:border-[#23BE0A] px-7 WorkSans">Read</button>
                    <button className="btn bg-[#50B1C9] text-lg font-semibold hover:bg-[#50B1C9] text-white Worksans">Wishlist</button>
                  </div>
                </div>
              </div>
            </div>
